 ...
 * <br>
 * <br>
 * The CodecJOrbis class provides an ICodec interface to the external JOrbis library. <b><i> SoundSystem CodecJOrbis
 * Class License:</i></b> <br>
 * <b><br>
 * You are free to use this class for any purpose, commercial or otherwise. You may modify this class or source code,
 * and distribute it any way you like, provided the following conditions are met: <br>
 * 1) You may not falsely claim to be the author of this class or any unmodified portion of it. <br>
 * 2) You may not copyright this class or a modified version of it and then sue me for copyright infringement. <br>
 * 3) If you modify the source code, you must clearly document the changes made before redistributing the modified
 * source code, so other users know it is not the original code. <br>
 * 4) You are not required to give me credit for this class in any derived work, but if you do, you must also mention my
 * website: http://www.paulscode.com <br>
 * 5) I the author will not be responsible for any damages (physical, financial, or otherwise) caused by the use if this
 * class or any portion of it. <br>
 * 6) I the author do not guarantee, warrant, or make any representations, either expressed or implied, regarding the
 * use of this class or any portion of it. <br>
 * <br>
 * Author: Paul Lamb <br>
 * http://www.paulscode.com </b><br>
 * <br>
 * <b> This software is based on or using the JOrbis library available from http://www.jcraft.com/jorbis/ </b><br>
 * <br>
 * <br>
 * <b> <br>
 * <br>
 ...
 * <br>
 */
public class XCodecJOrbis implements ICodec {
	/**
	...
	public boolean initialize(URL url) {
		...
		if (file != null) {
			try {
				inputStream = Loader.createCipherInputStream(file);
			} catch (Exception e) {
				errorMessage("Unable to create a UrlConnection in method " + "'initialize'.");
				printStackTrace(e);
				cleanup();
